...
graph TD;
    ...
    J --|Да|--> K[Возврат: "<"]
    K --> L[Вывод: "Строго левее"]

    J --|Нет|--> M{C > B}
    
    M --|Да|--> N[Возврат: ">"]
    N --> O[Вывод: "Строго правее"]
    ...
    V --|Да|--> W[Возврат: "<= (left and in)"]
    W --> X[Вывод: "Слева и внутри"]
    
    V --|Нет|--> Y{C >= A и D > B}
    
    Y --|Да|--> Z1[Возврат: ">= (right and in)"]
    Z1 --> Z2[Вывод: "Справа и внутри"]
    
    Y --|Нет|--> A1[Возврат: "overlap"]
    A1 --> A2[Вывод: "Пересечение"]
